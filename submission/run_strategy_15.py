...
dict_kmeans_model = fit_cluster(data_train_copy,ks=[2, 10, 40, 50, 100, 200, 300,500,1000,1500,2000],s_perc = 1)
...
for k in [2, 10, 40, 50, 100, 200, 300,500,1000,1500,2000]:
...
result.to_csv("sub_strategy_15.csv", index=False)
